...
import 'package:flutter_banking_app/pages/Bottom_nav_pages/add_card.dart';
...
class VirtualCardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: myAppBar(
          title: 'Virtual Cards', implyLeading: true, context: context),
      body: ListView(
        ...
        children: [
          ...
          InkWell(
            onTap: () => Navigator.push(
                context, MaterialPageRoute(builder: (c) => const AddCard())),
            child: Container(
              ...
              child: Row(
                ...
                children: const [
                  ...
                  Gap(10),
                  Text('CREATE NEW CARD', style: TextStyle(color: Colors.white))
                ],
              ),
            ),
          ),
